...
public class ContentProvider3 extends ContentProvider {

    static final String PROVIDER_NAME = "technologies.lnthales.com.lttech.ContentProvider3";
    ...
    static final String TABLE_NAME = "empp";
